...
public interface RepoController<T> {
	...
	/**
     * Zwraca wydarzenie podanego dnia o podanej nazwie. Jeśli wydarzenie nie istnieje zwraca null.
     ...
     * @return Wydarzenie, o którym musi zostać wyświetlone przypomienie lub null jeśli takiego nie ma.
     */
     ...
     * @param t Wydarzenie, na które ma zostać zamienione wydarzenie o podanym indeksie.
     */
     ...
     * @param newEvent Wydarzenie, którego wartościami pól mają zostać zmodyfikowane wartości pól wydarzenia "oldEvent".
     */
